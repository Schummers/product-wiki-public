...
- [Quantitative Usability Testing (Benchmarking)](#toc-quantitative-usability-testing-benchmarking-1)
- [Web Analytics (or App Analytics)](#toc-web-analytics-or-app-analytics-2)
- [A/B Testing or Multivariate Testing](#toc-ab-testing-or-multivariate-testing-3)
- [Card Sorting](#toc-card-sorting-4)
- [Tree Testing](#toc-tree-testing-5)
- [Surveys and Questionnaires](#toc-surveys-and-questionnaires-6)
- [Clustering Qualitative Data](#toc-clustering-qualitative-data-7)
- [Desirability Studies](#toc-desirability-studies-8)
- [Eyetracking Testing](#toc-eyetracking-testing-9)
- [Choosing a Method](#toc-choosing-a-method-10)
- [Resources](#toc-resources-11)
...
For all the skills you need to run a basic quantitative usability-testing study, see our full-day course [Measuring User Experience](https://www.nngroup.com/courses/measuring-ux/).
...
A major downside to this methodology is that it’s [often abused](https://www.nngroup.com/articles/putting-ab-testing-in-its-place/). Some teams fail to run the tests as long as they should, and make risky decisions based on small numbers.
...
For example, imagine you run a [diary study](https://www.nngroup.com/articles/diary-studies/) asking participants to report every time they use your product in their daily lives for a week, with the goal of understanding in what context they use your products. You may count the instances when people used the product at work, in their homes, or on the go.
...
Method | Typically Used for | Cost | Difficulty of Collection | Difficulty of Analysis | Type | Context of Use | Quantitative Usability Testing | Tracking usability over time | Comparing competitors | Medium | Medium | Medium | Behavioral | Task-Based | Web Analytics (or App Analytics) | Detecting or prioritizing problems | Monitoring performance | Low | Low | High | Behavioral | Live | A/B Testing | Comparing two specific design options | Low | Low | Low | Behavioral | Live | Card Sorting | Determining IA labels and structures | Low | Low | Medium | Attitudinal | Not Using Product | Tree Testing | Evaluating IA hierarchies | Low | Low | Medium | Behavioral | Not Using Product | Surveys and Questionnaires | Gather information about your users, their attitudes, and behaviors | Low | Low | Low | Attitudinal | Any | Clustering Qualitative Comments | Identifying important themes in qualitative data | Low | Medium | Medium | Attitudinal | Any | Desirability Studies | Identifying attributes associated to your product or brand | Low | Low | Low | Attitudinal | Task-Based | Eyetracking Testing | Determining which UI elements are distracting, findable, or discoverable | High | High | High | Behavioral | Task-Based
...
[“UX Research Cheat Sheet”](https://www.nngroup.com/articles/ux-research-cheat-sheet/) (Article)
