...
date: "2020-02-23"
url: "https://www.nngroup.com/articles/calculating-roi-design-projects/"
author: "Kate Moran"
topics: []
type: article
---
...
- [Step 1: Collect a UX Metric in a Benchmarking Study](#toc-step-1-collect-a-ux-metric-in-a-benchmarking-study-1)
- [Step 2: Choose a KPI](#toc-step-2-choose-a-kpi-2)
- [Step 3: Convert the UX Metric into the KPI](#toc-step-3-convert-the-ux-metric-into-the-kpi-3)
- [Step 4: Report Responsibly](#toc-step-4-report-responsibly-4)
- [Why Bother Calculating ROI?](#toc-why-bother-calculating-roi-5)
...
Surveys | Analytics | Quantitative | Usability Testing | Customer Support | Satisfaction rating | Ease-of-use rating | Perceived usability | Questionnaire scores | (NPS, SUS, SUPR-Q) | Frequency of return visits | Feature usage | New accounts or visitors | Conversion rate | Returning visitors | Renewal rate | Churn | Completion rate | Error counts & rate | Success rate | Time on task | Error rate | Productivity | (for example, number of | orders processed in an hour) | Customer-support tickets | Phone calls, chats, emails, texts | Training hours required | Number of client complaints
