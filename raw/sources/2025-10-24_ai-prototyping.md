---
title: "Good from Afar, But Far from Good: AI Prototyping in Real Design Contexts"
date: "2025-10-24"
url: "https://www.nngroup.com/articles/ai-prototyping/"
author: "Huei-Hsin Wang, Megan Brown"
topics: [ai, interaction-design, prototyping, ux-design-process]
type: article
---
...
- [About the Evaluation](#toc-about-the-evaluation-1)
- [Specific Prompts Lead to Better Outputs](#toc-specific-prompts-lead-to-better-outputs-2)
- [AI Reflects Patterns from Its Training Data](#toc-ai-reflects-patterns-from-its-training-data-3)
- [Using AI Prototyping Tools in Real Workflows](#toc-using-ai-prototyping-tools-in-real-workflows-4)
...
![The profile page designs generated by AI tools like Bolt and UX Pilot using a detailed prompt closely resembled the human-designed version in layout, component selection, and visual treatment.n created by the NN/G designer.](https://media.nngroup.com/media/editor/2025/10/17/1-prompt-2-vs-human-designs_6rb7ej2.jpg)

*Designs generated from a detailed text prompt (Prompt 2) closely matched the human-designed version. (**Note: Besides the two examples shown here, other tools also generated high-quality results.*[See the full set of outputs on the FigJam board](https://www.figma.com/board/gLi4O1jr7Lo1AWQPZAdKXg/NN-G-AI-Prototyping-Evaluation?node-id=0-1&t=f4QxQFSnnAZ6Xky6-1)*.)*
...
![Designs generated by Claude, Figma Make, v0, and Stitch differed significantly in layout, design patterns, and overall aesthetics.](https://media.nngroup.com/media/editor/2025/10/17/2-prompt-1.jpg)

*Designs generated by AI in response to the same broad text prompt (Prompt 1) varied widely across tools. (*[See the full set of outputs on the FigJam board](https://www.figma.com/board/gLi4O1jr7Lo1AWQPZAdKXg/NN-G-AI-Prototyping-Evaluation?node-id=0-1&t=f4QxQFSnnAZ6Xky6-1)*.)*
...
The saying *An image is worth a thousand words* proves remarkably accurate here. When AI tools can examine existing patterns, spatial relationships, hierarchy, and aesthetic treatments through the artifacts you provide, they can produce more consistent and accurate designs that match your vision. The irony is that by providing these references, **you’ve already completed much of the design work yourself.**

![When the prompt included a link to a Figma design frame, AI tools such as Lovable and Replit produced designs that most accurately matched the NN/g designer’s original.](https://media.nngroup.com/media/editor/2025/10/17/3-prompt-3c.jpg)

*Prompts including a Figma frame (Prompt 3c)******produced the most accurate translation of the original design. (** Note: Besides the two examples shown here, other tools also generated accurate results.*[See the full set of outputs on the FigJam board](https://www.figma.com/board/gLi4O1jr7Lo1AWQPZAdKXg/NN-G-AI-Prototyping-Evaluation?node-id=0-1&t=f4QxQFSnnAZ6Xky6-1)*.)*
...
![The interface resembles a learning dashboard showing certification progress and course cards. Annotated callouts highlight specific visual issues, including poor color contrast, tight icon margins, excessive spacing between related information, and competing element styles.](https://media.nngroup.com/media/editor/2025/10/17/4-nng-design-v-bolt.jpg)

*The AI output in response to a detailed text prompt (Prompt 2) missed subtle but important details related to spacing, grouping, and hierarchy.*
...
![The left design, labeled “Bolt,” features a simple card layout with progress stats and course lists. The right design, labeled “Claude,” shows a similar minimal interface with soft gray backgrounds and colored status tags. Both designs share clean, understated styling with bright accent colors but little visual differentiation or brand expression.](https://media.nngroup.com/media/editor/2025/10/17/5-indistinctive-style.jpg)

**❌*** When visual styles aren’t **specified in the prompt, AI-generated designs default to neutral, minimalistic visual aesthetics with bright color accents.** While the clean, subtle style is a safe default, it lacks visual identity and emotion.*
...
For example, our prompts used the phrase “*profile page*.” Depending on the context, that phrase can point to different patterns. In our case, a profile page was meant to be a personal page for a course attendee, not a public-facing profile. But when we used a high-level prompt (prompt 1) without specifying which components to include, several AI prototyping tools interpreted “profile” as a social-media profile and created profile widgets that resembled the ones used for social media (like a LinkedIn profile banner).

![The interface prominently features a large user profile section with a photo, name, and contact information at the top center. Progress indicators and course statistics are displayed above, while course listings with completion details and scores appear below. A left navigation menu lists profile, courses, certifications, and settings. The layout visually emphasizes personal and contact details over task-related course content.](https://media.nngroup.com/media/editor/2025/10/17/6-replit.jpg)

**❌*** When given a high-level goal, the tool applied a pattern that emphasized user information (e.g., email, contact, role). This design pattern, while common on social media platforms like LinkedIn, is less effective in our design context as unnecessary visual attention is placed over information that is not essential for the main task.*
