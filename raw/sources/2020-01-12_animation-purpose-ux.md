...
Your browser does not support the video tag.*Airtable: When drag-and-drop is used to reorder columns in a table, a subtle animation gives a preview of the new order before the user lets go and commits to the action.*
...
Your browser does not support the video tag.*Apple Music for iPhone: the* Now Playing *card animates up into place in a manner that helps the user understand that this view can be dismissed by pulling down, rather than swiping left or right on the edge.* Your browser does not support the video tag.
...
Your browser does not support the video tag.*Distracting: The moving squiggle on Outline’s content pages adds no benefit, but needlessly draws the attention of the user away from the content.* Your browser does not support the video tag.
