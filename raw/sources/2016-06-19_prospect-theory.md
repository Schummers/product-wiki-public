---
title: "Prospect Theory and Loss Aversion: How Users Make Decisions"
date: "2016-06-19"
url: "https://www.nngroup.com/articles/prospect-theory/"
author: "Aurora Harley"
topics: [behavior-patterns, persuasive-design, psychology-and-ux]
type: article
---
...
> **Prospect theory:** How people choose between different options (or prospects) and how they estimate (many times in a biased or incorrect way) the *perceived* likelihood of each of these options.
...
![Decision diagram of scenario involving sure gains](https://media.nngroup.com/media/editor/2016/06/08/diagram1-gain.png)
...
![Decision diagram of scenario involving sure losses](https://media.nngroup.com/media/editor/2016/06/08/diagram1-loss.png)
...
- [Certainty](#toc-certainty-1)
- [Isolation Effect](#toc-isolation-effect-2)
- [Loss Aversion](#toc-loss-aversion-3)
- [Guard Users Against Negative Experiences](#toc-guard-users-against-negative-experiences-4)
...
![Screenshot of email from Aveda.com asking to write a product review](https://media.nngroup.com/media/editor/2016/06/08/avedareviewemail_cropped.png)
...
Remembering all the details of each individual option creates too much of a [cognitive load](https://www.nngroup.com/articles/minimize-cognitive-load/), so it only makes sense to **focus on the differentiators**. Discarding common elements lessens the burden of comparing alternatives, but can also lead to inconsistent choices depending on how alternatives are presented.
...
![Decision diagram of 2 scenarios framed as either a gain or a loss, with initial gift amounts](https://media.nngroup.com/media/editor/2016/06/08/diagram_isolationeffect.png)
...
When creating content to persuade people into making a certain choice, consider how it is framed. People can respond very differently to negatively framed messages than they would to a positively framed one. Would you rather use a service that has a 95% satisfaction rate or one that has a 5% complaint rate? The negative formulation [primes](https://www.nngroup.com/articles/priming/) people to think of the possible “loss” or negative outcome and to act accordingly.

You should also consider how information is displayed to help users identify common elements that can be safely disregarded to focus on key differentiators. For example, presenting a product configurator versus having users choose among different products as a whole. Seeing every possible final permutation of products or services may cause prospective customers to make a different decision (or just overwhelm them and lead them to abandon the task) than if they were presented one or two products and then given the option to [customize them by adding features](https://www.nngroup.com/articles/customization-of-uis-and-products/).

Another way to support this simplification process in product comparisons is to present important information side-by-side rather than only through each individual product page. Comparison tables that [highlight differences](https://www.nngroup.com/articles/explicit-differences/) work well, as long as consistent levels of detail are included for all items. One of the most common activities on the web involves users [comparing and choosing](https://www.nngroup.com/articles/the-3cs-of-critical-web-use-collect-compare-choose/) between multiple products or services, so adequately supporting this task is key.
...
![Screenshot of pet insurance web page listing possible health expenses](https://media.nngroup.com/media/editor/2016/06/08/protect-your-cat.png)
