...
topics: [customer-journeys, ux-ideation, ux-management]
type: article
---

## In This Article:

- [What Is a Service?](#toc-what-is-a-service-1)
- [Definition of Service Design](#toc-definition-of-service-design-2)
- [Components of ‘Service Design’](#toc-components-of-service-design-3)
- [Service Design vs. Designing a Service](#toc-service-design-vs-designing-a-service-4)
- [Benefits of Service Design](#toc-benefits-of-service-design-5)
- [History of Service Design](#toc-history-of-service-design-6)
...
![NN/g Service Design 101: Goods-Services Continuum](https://media.nngroup.com/media/editor/2017/07/06/screen-shot-2017-07-06-at-34638-pm.png)
...
Imagine a restaurant where there are a range of employees: hosts, servers, busboys, and chefs. Service design focuses on how the restaurant operates and delivers the food it promises—from sourcing and receiving ingredients, to on-boarding new chefs, to server-chef communication regarding a diner’s allergies. Each moving part plays a role in the food that arrives on the diner’s plate, even though it is not directly part of their experience. Service design can be mapped using a [service blueprint](https://www.nngroup.com/articles/service-blueprints-definition/).

![NN/g Service Design 101](https://media.nngroup.com/media/editor/2017/07/08/servicedesign101-05.png)
...
![NN/g Service Design: Frontstage vs. Backstage](https://media.nngroup.com/media/editor/2017/07/06/screen-shot-2017-07-06-at-35328-pm.png)
...
- [Channels](https://www.nngroup.com/articles/channels-devices-touchpoints/)
- Products
- [Touchpoints](https://www.nngroup.com/articles/channels-devices-touchpoints/)
- Interfaces
