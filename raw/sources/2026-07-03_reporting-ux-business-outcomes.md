...
date: "2026-07-03"
url: "https://www.nngroup.com/articles/reporting-ux-business-outcomes/"
author: "Lola Famulegun"
topics: [analytics-and-metrics, ux-management]
type: article
---
...
- [Two Mistakes that Make UX Look Like a Cost Center](#toc-two-mistakes-that-make-ux-look-like-a-cost-center-1)
- [How Leaders Actually Evaluate Investments](#toc-how-leaders-actually-evaluate-investments-2)
- [Connecting UX Metrics to What Leadership Cares About](#toc-connecting-ux-metrics-to-what-leadership-cares-about-3)
...
[Research from McKinsey](http://mckinsey.com/capabilities/mckinsey-digital/our-insights/the-business-value-of-design) found that more than half of companies had no objective way to assess the output of their design teams. When UX can't report in the language of business, leaders rely on gut feel or on the teams that can.
...
Design-caused errors such as missed transactions, incorrect [form](https://www.nngroup.com/articles/web-form-design/) submissions, and misunderstood instructions can create downstream legal, support, compliance, and financial risks. Research that surfaces these failure modes before launch is [risk mitigation](https://www.nngroup.com/articles/design-risk-management/). The cost of a usability study is small relative to the cost of a compliance violation, a product recall, or a public incident caused by a product that was never tested with real users.
...
Metric | Business Priority | How to frame it | Task-success rate | Revenue | Failed tasks generate support contacts. Friction in checkout and signup suppresses revenue. | Error rate | Reduce cost | Design-caused errors create refunds, reprocessing costs, and compliance exposure. | SUS scores | Mitigate risk | Building the wrong thing and experience-based errors create financial risks and opportunity costs. | Post-launch fixes | Speed to market | Earlier UX involvement reduces rework cycles and the number of emergency patches. | First-use completion | Retention | Users who don't complete onboarding churn early. | CSAT | Satisfaction | Satisfaction predicts renewal and expansion.
