---
title: "GenAI for Complex Questions, Search for Critical Facts"
date: "2026-02-27"
url: "https://www.nngroup.com/articles/ai-search-infoseeking/"
author: "Josh Brown, Maria Rosala"
topics: [ai, search]
type: article
---

Users are increasingly [turning to generative AI (genAI) for information-seeking tasks](https://www.nngroup.com/articles/ai-changing-search-behaviors/) — but not uniformly. In a recent study, we observed how people chose between AI chatbots and traditional search for real tasks. Users turned to AI when they started with vague ideas, juggled multiple requirements, or combined information from many sources. They used traditional search when they needed accuracy, control, and trusted sources.

## In This Article:

- [Why Users Turn to GenAI](#toc-why-users-turn-to-genai-1)
- [Why Users Still Turn to Search](#toc-why-users-still-turn-to-search-2)
- [About the Study](#toc-about-the-study-3)
...
> "It’s (...) one of the most helpful places to start. (...) It can really help direct me into a more narrow type of search."PROMO
...
This also allowed users to bypass a common frustration in traditional search: [keyword foraging](https://www.nngroup.com/articles/ai-information-seeking-keyword-foraging/) — the trial-and-error process of guessing which search terms yield useful results. By offloading that cognitive burden to AI, users could focus more on refining their goals, rather than reverse-engineering the right query.
...
(Although Google now has [AI mode](https://www.nngroup.com/articles/google-ai-mode/), this feature was relatively new in our study and underutilized due to its [low discoverability](https://www.nngroup.com/articles/discoverability-ai-amazon/).)

### AI Saves Interaction Cost

Several participants mentioned that using AI saved them clicks that they would have had to spend visiting multiple websites to acquire all that information, and thus [shortcut the task of information foraging](https://www.nngroup.com/articles/generative-ai-diary/).
...
GenAI chatbots aggregate a lot of information and **present only what’s relevant to the user’s query,** saving users the [interaction cost](https://www.nngroup.com/articles/interaction-cost-definition/) and [cognitive load](https://www.nngroup.com/articles/minimize-cognitive-load/) involved in doing the same work by themselves.
...
AI chatbots reduce clicks by aggregating information that would otherwise require visiting multiple websites.
...
Beyond saving clicks, AI also reduces another hidden cost of doing research: working-memory load. When users search for information online to make a choice, they often must compare details across multiple options. Design solutions (such as presenting options on the same page, [comparison tables](https://www.nngroup.com/articles/comparison-tables/), [filters](https://www.nngroup.com/articles/filters-vs-facets/)) can help with this task.

However, **users frequently compare options across different websites** or sources. To do so, traditionally, they would either keep all the candidate choices in their [working memory](https://www.nngroup.com/articles/working-memory-external-memory/) or use some form of [external memory](https://www.nngroup.com/articles/working-memory-external-memory/), such as [page parking](https://www.nngroup.com/articles/multi-tab-page-parking/) or notes.
...
Another advantage of AI is that users can ask it to display information in tables or another format supporting comparisons. Users with higher [AI literacy](http://nngroup.com/articles/ai-literacy) utilized this strategy in their prompts.
...
![The image shown is ChatGPT presenting 5 beach options with pros and cons in a table. Pros include things like "walkable from downtown" "ample parking", cons include things like, "not ideal for swimming," and "parking can be limited."](https://media.nngroup.com/media/editor/2026/02/19/montauk-beach-options-table.jpg)
...
This behavior reflected users’ [mental model](https://www.nngroup.com/articles/mental-models/) of genAI as helpful but fallible. We saw AI make mistakes multiple times during the sessions. For example, when our participant asked ChatGPT for golf resorts in the Midwest, it listed a resort in New York. The participant noticed the mistake and remarked:
...
![Google AI Mode is shown. After several sections of text, there is just one citation link. In the right rail, there is a list of websites and sources.](https://media.nngroup.com/media/editor/2026/02/17/risks-benefits-omega-3.png)
...
Similarly, another participant seeking new research on brain microstructures avoided ChatGPT because it commonly hallucinates papers and authors. He also noted that ChatGPT lacks access to paywalled articles and preferred [Notebook.LM](https://notebooklm.google.com/) for conducting academic literature research.

## About the Study

In a remote observational study, we asked participants with varying levels of AI experience and tech-savviness to bring real-life things they wanted to research online. We wanted to learn how users use [generative AI in the information-seeking process.](https://www.nngroup.com/articles/ai-changing-search-behaviors/)

How and where users chose to use AI in the information-seeking process depended on the nature of the task. Users brought and performed two main [types of tasks](https://www.nngroup.com/articles/information-seeking-expectations/):
...
UNDERSTAND TASKS | Learn about a topic | Learn about James Madison’s presidency | Find new research on brain microstructures | Learn the risks and benefits of Omega-3 supplements | Learn how to do something | Learn how to remove odors from a sofa | Learn how to get stains out of towels | Learn how to fix a leaky drain pipe | Learn how to get free books on a Kindle | CHOOSE TASKS | Trip planning | Which hikes to do in Arizona | Which beaches to visit on Montauk Island | Where to go for a group golfing trip | Where to visit in Puerto Rico | Purchase something | Choose a car model | Choose a smart refrigerator | Choose a portable soccer goal
