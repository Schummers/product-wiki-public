---
title: "How AI Literacy Shapes GenAI Use"
date: "2026-02-06"
url: "https://www.nngroup.com/articles/ai-literacy/"
author: "Maria Rosala"
topics: [ai, behavior-patterns]
type: article
---

In my career as a UX researcher (particularly in civic tech and digital inclusion), I’ve spent years observing how people use the internet. As [AI changes how users search](https://www.nngroup.com/articles/ai-changing-search-behaviors/) for, create, and communicate information in both personal and professional contexts, it’s becoming an essential new dimension of digital literacy — one that introduces new competencies.

Despite the hype, not everyone is using generative AI (genAI) tools, such as ChatGPT and Gemini. And, those who are using it aren’t all using it in the same way. People working in technology often take for granted a level of comfort or sophistication with AI that many users simply don’t have. (Remember, [you are not your user!](https://www.nngroup.com/articles/false-consensus/)) Understanding how users with low AI literacy interact with generative AI (genAI) is critical in designing inclusive and supportive AI experiences.

## In This Article:

- [AI Literacy and Digital Literacy](#toc-ai-literacy-and-digital-literacy-1)
- [Our Study](#toc-our-study-2)
- [Prompt Fluency: From Keywords to Conversations](#toc-prompt-fluency-from-keywords-to-conversations-3)
- [Output Literacy: Evaluating and Verifying Outputs](#toc-output-literacy-evaluating-and-verifying-outputs-4)
- [How Designers Can Help Users on Both Dimensions](#toc-how-designers-can-help-users-on-both-dimensions-5)
...
AI introduces [new interaction paradigms](https://www.nngroup.com/articles/ai-paradigm/) that require new [mental models](https://www.nngroup.com/articles/mental-models/) — ones that don’t always align with users' past experiences with search engines or traditional software.

In our research, two distinct capabilities shaped people’s success when using genAI for information seeking.

1. **Prompt fluency**: The ability to communicate intent, constraints, and context so that genAI can produce useful outputs.
2. **Output literacy**: The ability to evaluate genAI outputs --- for example, spotting gaps or misunderstandings, noticing potential [hallucinations](https://www.nngroup.com/articles/ai-hallucinations/), seeking sources, and crosschecking when accuracy matters.
...
![A matrix displaying prompt fluency on the y-axis (or vertical axis) and Output Literacy on the x-axis (or horizontal axis). Four different users are shown. The AI Novice at the bottom left-corner, a naive power user who sits above them, high on the prompt fluency axis but low on the output literacy. In the top-most right corner is the AI Expert, and below them is the Skeptical abstainer who is high on the axis for output literacy but low on the prompt fluency axis.](https://media.nngroup.com/media/editor/2026/01/28/how-ai-literacy-shapes-genai-use.png)
...
![A Gemini output with a large popup including terms and conditions like "Gemini can make mistakes, so double-check it."](https://media.nngroup.com/media/editor/2026/01/28/gemini-welcome-message.png)

*A novice user worked for ten minutes using Gemini and didn’t read the welcome message. She eventually dismissed it.*

![A Perplexity landing page with the pop up "Try adding more detail."](https://media.nngroup.com/media/editor/2026/01/28/perplexity.png)

*The same user ignored the help text or suggested topics in Perplexity.*

These examples illustrate two common UX problems: **users don’t want to read**[onboarding messages](https://www.nngroup.com/articles/onboarding-tutorials/), and helpful guidance is often **buried within or beneath long AI-generated responses**.

![A ChatGPT output. It says, at the end, "If you want, tell me: Are you shopping, troubleshooting, or designing a smart refrigerator?" At the bottom there is a small disclaimer "ChatGPT can make mistakes. Check important info."](https://media.nngroup.com/media/editor/2026/01/28/chatgpt-smart-refrigerator-example.png)

*ChatGPT offers suggestions for a next step and an evergreen warning about accuracy (below the prompt field), but these can be missed easily by users.*
...
- Use [intentionally uncertain language](https://www.nngroup.com/articles/ai-hallucinations/) when information may be outdated or hard to confirm
...
S. M. Tully, C. Longoni, and G. Appel. 2025. Lower Artificial Intelligence Literacy Predicts Greater AI Receptivity. *J. Mark.* 89, 5 (2025), 1–20 [https://doi.org/10.1177/00222429251314491](https://doi.org/10.1177/00222429251314491)
