...
- [What Is a User Panel?](#toc-what-is-a-user-panel-1)
- [When Does a User Panel Help?](#toc-when-does-a-user-panel-help-2)
- [Types of Panels](#toc-types-of-panels-3)
- [6 Steps to Build a User Panel](#toc-6-steps-to-build-a-user-panel-4)
- [Choosing Tools for Your Panel](#toc-choosing-tools-for-your-panel-5)
- [Advocating for Your Own Panel](#toc-advocating-for-your-own-panel-6)
...
But more than that, **a panel functions as infrastructure**, not just a list. It connects fragmented recruiting efforts across teams, serves as a living asset, and supports consistency in the research process. This foundation helps ensure that user input isn’t limited to isolated projects but becomes a steady part of how decisions are made — an important marker of higher [UX maturity](https://www.nngroup.com/articles/ux-maturity-model/).
...
Panel Type | Description and Fit | Strengths | Challenges | Customer Panel | People who already use your product | High trust, context-rich feedback | Overfamiliarity | Target-user Panel | People who match your intended personas but are not users yet | Fresh perspective, innovation insight | Harder to recruit, less brand affinity
...
**B2C companies** (like [Duolingo](https://www.duolingo.com/efficacy/research)) recruit customers who interact directly with their product for rapid feedback from large, diverse audiences. These panels focus on usability, satisfaction, and continuous engagement with everyday users.

**B2B companies** (like [Atlassian](https://www.atlassian.com/research-group)) recruit professionals — admins, developers, or team leads — who use their tools for work. These panels emphasize productivity, workflow optimization, depth and domain expertise, and long-term adoption.
...
1. **Recruit:** Invite users to join your panel through in-product prompts, email outreach, marketing efforts, or community engagement.
2. **Organize and segment:** Store your opted-in panelists in a system that allows you to track their attributes and contact them later.
3. **Contact and schedule:** Once you have a study request that your panel can fill, you can invite matches to specific studies.
4. **Incentivize and engage:** Just as with any participant, you’ll incentivize them appropriately and use the incentive as a way to maintain their motivation and expectations around being panelists.
5. **Reengage and manage:** Use your system to track their participation history, keep their information up-to-date, and rotate outreach to avoid fatiguing these valued customers.
6. **Govern and improve:** Establish clear ownership and policies internally for who can access, contact, or update the panel. Governance ensures privacy compliance, consistent communication, and long-term sustainability.

![Six steps for building a user panel grouped into three phases: Setup, Ongoing Needs, and Governance, showing how panel work progresses from initial setup through ongoing management to long-term oversight.](https://media.nngroup.com/media/editor/2026/01/05/user-panels-101-2026-compressed.png)

*Building a user panel requires upfront setup, ongoing operational work, and clear governance to sustain it over time.*
