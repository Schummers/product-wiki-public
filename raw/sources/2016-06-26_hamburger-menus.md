...
author: "Kara Pernice, Raluca Budiu"
topics: [design-patterns, mobile-and-tablet-design, navigation]
type: article
---
...
- [Why Study Hidden and Visible Navigation](#toc-why-study-hidden-and-visible-navigation-1)
- [Measures: Navigation Usage, Content Discoverability, Time, Task Difficulty](#toc-measures-navigation-usage-content-discoverability-time-task-difficulty-2)
- [Navigation Usage: Hidden Navigation Used Less and Later in the Task](#toc-navigation-usage-hidden-navigation-used-less-and-later-in-the-task-3)
- [Hidden Navigation Leads to Worse User Experience](#toc-hidden-navigation-leads-to-worse-user-experience-4)
- [Why Hidden Navigation Is Less Effective](#toc-why-hidden-navigation-is-less-effective-5)
- [Navigation Recommendations](#toc-navigation-recommendations-6)

## Why Study Hidden and Visible Navigation

[Responsive design](https://www.nngroup.com/articles/responsive-web-design-definition/) has [many merits](https://www.nngroup.com/articles/mobile-usability-update); however, one of its less fortunate effects has been an excessive popularity of mobile-first designs that translate poorly onto larger desktop screens. To be clear, “mobile-first” itself is not the issue. Rather, the issue is taking sufficiently good mobile designs and porting them to desktops where they do not work as well. *Mobile-first* should not equal *mobile-only.*

(Obviously, there’s a general principle here: if a design technique is intended to span platforms X and Y, then an uncompromising *X-first* approach will make Y an afterthought and harm users on Y. To design for X *and* Y, you need to consider the strengths and needs of both and adapt the two versions of the website accordingly.)

Hidden navigation, such as the hamburger menu, is one of the many patterns inspired by mobile designs. Screen space is a precious commodity on mobile. To meet the challenge of [prioritizing content](https://www.nngroup.com/articles/content-chrome-ratio) while still making navigation (and other [chrome](https://www.nngroup.com/articles/browser-and-gui-chrome/)) accessible, designers commonly rely on hiding the navigation under a menu — often indicated by the infamous hamburger icon. Like a cheap fast food chain, it got designers addicted to its convenience, and now serves millions each day, both on mobile devices and on desktops.

While our qualitative user testing has repeatedly shown that [navigation hidden under a drop-down menu is less discoverable on the desktop](https://www.nngroup.com/articles/killing-global-navigation-one-trend-avoid/), we wanted to measure the size of this effect in a quantitative study and assess the relative impact of hidden navigation on the desktop versus mobile. To do so, we partnered with [WhatUsersDo](http://whatusersdo.com/?utm_campaign=nng_hamburger_1&utm_medium=referral&utm_source=ext_article) (a company specializing in remote usability testing) to run a study with 179 participants who completed tasks on 6 different sites, both on smartphones and desktops. The results of this large study are reported in this article. An additional article includes our [detailed research methodology and images of the menus](https://www.nngroup.com/articles/hidden-navigation-methodology/) tested.
...
The first 2 metrics are related to navigation usage, while the last 3 refer to the quality of the user experience.

(More on different types of UX metrics and how to collect and analyze them in our full-day course [Measuring User Experience](https://www.nngroup.com/courses/measuring-ux/).)
...
For example, on certain pages and tasks, an in-line link may have high [information scent](https://www.nngroup.com/articles/information-scent/) — think of looking for a movie on a newspaper site: if the first headline that you see on the page is exactly about that movie, chances are that you’ll pick it without using navigation or search.
...
![Bar graph with data as described in the following paragraphs](https://media.nngroup.com/media/editor/2016/06/25/perc-x3.PNG)
...
- Mobile pages tend to require more scrolling, have less content [visible above the fold](https://www.nngroup.com/articles/page-fold-manifesto/), and sometimes be slower to load, so people may resort to using a menu instead of looking on the page and exploring whether there is any content that matches their interest. On the desktop, page-load speeds are high and the larger screen offers a better preview of the content of the page. (In other words, the [interaction cost](https://www.nngroup.com/articles/interaction-cost-definition/) of accessing a desired piece of information is higher on mobile than on the desktop.)

Typing is harder and more error prone on mobile, and people may be more likely to prefer [navigation instead of searching](https://www.nngroup.com/articles/search-not-enough/), when the navigation is available.
...
![Bar graph showing time to hidden navigation for desktop taking 31 seconds, versus 23 and 26 seconds for combo and visible navigation. On mobile, times were 26 versus 24 seconds for hidden versus combo navigation.](https://media.nngroup.com/media/editor/2016/06/25/timetonav-x3.PNG)
...
![Bar chart showing discoverability differences between hidden, combo, and visible navigation conditions. Hidden navigation again scored the lowest, with combo again the winner. Details in the text following.](https://media.nngroup.com/media/editor/2016/06/25/discov-x3.PNG)
...
![Bar chart showing task difficulty on a scale of 1 to 7. Hidden 2.6, Combo 2.3, Visible 2.1.](https://media.nngroup.com/media/editor/2016/06/25/difficulty-x3.PNG)
...
![Bar chart showing hidden navigation is slowest to use compared with the combo or visible navigation on both desktop and mobile. .](https://media.nngroup.com/media/editor/2016/06/25/tasktime-x3.PNG)
...
2. **Desktop users were faster than mobile users (when combining all types of navigation)** On average, mobile users took 12% more time to complete the tasks. This result is not surprising: due to the small screen and the [narrow communication channel](https://www.nngroup.com/articles/scaling-user-interfaces) between the user and the device, getting the same content on mobile usually requires more interaction.
...
5. **Low familiarity**: Especially on desktops, hiding navigation is not a common pattern and people may not expect to find global navigation under an expandable menu. Some people may also still be unfamiliar with the hamburger icon that is frequently used for such menus. This low familiarity is exacerbated by the lack of standards which reduce long-term learnability (as further discussed in our course on [The Human Mind and Usability](https://www.nngroup.com/courses/human-mind/), learning is facilitated by repeated exposure to the same pattern.)
...
- Provide in-page links to important information on your site, or use other methods of [supporting the hamburger](https://www.nngroup.com/articles/support-mobile-navigation/) (or some other hidden) menu.

Remember: [mobile-first is not the same as mobile-only](https://www.nngroup.com/articles/mobile-first-not-mobile-only/). Plus, of course, follow the other long-established [UX guidelines for menu design](https://www.nngroup.com/articles/menu-design/).
...
- [How to Make Navigation (Even a Hamburger) Discoverable on Mobile](https://www.nngroup.com/articles/find-navigation-mobile-even-hamburger/)
- [Beyond the Hamburger: How to Make Navigation Discoverable on Desktops](https://www.nngroup.com/articles/find-navigation-desktop-not-hamburger/)
