---
title: "The Case for Design Disposables"
date: "2026-05-22"
url: "https://www.nngroup.com/articles/design-disposables/"
author: "Laura Klein"
...
- [Not Everything You Make Needs to Go Somewhere](#toc-not-everything-you-make-needs-to-go-somewhere-1)
- [Why Disposables Matter (and Why We Avoid Making Them)](#toc-why-disposables-matter-and-why-we-avoid-making-them-2)
- [Sometimes You Have to Make the Thing to Know If It's the Right Thing](#toc-sometimes-you-have-to-make-the-thing-to-know-if-its-the-right-thing-3)
- [AI Makes This Easier and Harder at the Same Time](#toc-ai-makes-this-easier-and-harder-at-the-same-time-4)
- [A Quick Gut Check Before You Start](#toc-a-quick-gut-check-before-you-start-5)

## Not Everything You Make Needs to Go Somewhere

We talk a lot in UX about [deliverables](https://www.nngroup.com/articles/ux-deliverables-glossary/). These are the artifacts we hand off to stakeholders, developers, clients, or whoever else is waiting on our work. Deliverables matter. A well-crafted research report, a thoroughly annotated set of designs, a clear [task flow](https://www.nngroup.com/articles/user-journeys-vs-user-flows/) — these are things other people need to understand your work and act on it. They take time and care to produce, and that's appropriate.
...
When you sit down to work through a fuzzy problem, a research question you haven't fully formed, a design direction you haven't committed to, you need to be able to put something imperfect on paper without it meaning anything yet. You need the freedom to sketch a flow that you might throw out entirely, or write a [research](https://www.nngroup.com/articles/pm-research-plan/) plan you'll gut and rewrite before you ever share it.
...
This is the [sunk-cost fallacy](https://www.nngroup.com/articles/decision-framing-cognitive-bias-ux-pros/) applied to design artifacts, and it slows you down in a very specific way. It makes the [exploration phase](https://www.nngroup.com/articles/design-thinking/) of design feel expensive, which means you do less of it.

Here's the thing: exploration is supposed to be cheap.

## Sometimes You Have to Make the Thing to Know If It's the Right Thing

One of the sneakiest forms of design disposable is **a high-fidelity artifact you're treating as low-stakes**. Sometimes a quick [prototype](https://www.nngroup.com/articles/ux-prototype-hi-lo-fidelity/), a draft set of designs, or even a nearly complete task flow is the only way to figure out whether you're going in the right direction. You truly cannot evaluate the idea without seeing it.
...
If you want to go deeper on this, specifically on how to tell the difference between when you need a disposable versus a deliverable, and how to use both more effectively throughout your design and research process, [I created a new self-paced course](https://www.nngroup.com/contents/self-paced-courses/effective-ux-deliverables/). We get into the practical details of how to make these decisions in the moment, so you can spend your time on the right artifacts at the right stages of your work.
