...
date: "2021-08-08"
url: "https://www.nngroup.com/articles/ux-vs-service-design/"
author: "Sarah Gibbons"
topics: []
type: article
---

In our [service-blueprinting](https://www.nngroup.com/courses/service-design/) course, we often are asked about the difference between UX (or CX) and service design. They are two sides of the same coin.

## In This Article:

- [Comparing User Experience and Service Design](#toc-comparing-user-experience-and-service-design-1)
- [UX Alone Is Not Enough](#toc-ux-alone-is-not-enough-2)
- [UX and Service Design Together](#toc-ux-and-service-design-together-3)
- [Conclusion](#toc-conclusion-4)

## Comparing User Experience and Service Design

[User experience](https://www.nngroup.com/articles/definition-user-experience/) (which, for the purposes of this article, will be equated with [customer experience](https://www.nngroup.com/articles/ux-vs-cx/)) encompasses all aspects of users’ interaction with a company. It includes anything the end user comes across — for example, an app, kiosk, website, or a mailer. Think of user experience as the ‘**what**’ — what users encounter as they interact with a brand.

[Service design](https://www.nngroup.com/articles/service-design-101/) refers to planning and organizing business resources (people, props, and processes) to deliver the customer experience. Think of service design as the ‘**how**’ — how the user experience gets created and how the internal parts of the organization align to deliver that experience.

![UX vs. Service Design Comparison](https://media.nngroup.com/media/editor/2021/08/04/uxvsservicedesignnng.png)
...
For example, imagine encountering an issue that prompts you to contact a company’s support via a [customer-service chat.](https://www.nngroup.com/articles/chat-ux/) To begin, you must find and initiate the live chat. You communicate your issue, and the chat agent works with you to resolve it. These interactions, as well as the interface itself, make up the user experience. As you ask questions, the chat agent works behind the scenes as needed: checking a database, filling out a form, recording any changes in the database, speaking with a manager, and so forth. These tasks, as well as the people and technology required to complete them, are part of service design.
...
Optimizing UX and service design should be done parallel, with equal effort. It is important to think about what the end users encounter, while also considering logistically how that experience gets delivered. This relationship is easily visualized in a [service blueprint](https://www.nngroup.com/articles/service-blueprints-definition/).

![UX in a Service Blueprint Structure](https://media.nngroup.com/media/editor/2021/08/10/screen-shot-2021-08-10-at-73330-am.png)
