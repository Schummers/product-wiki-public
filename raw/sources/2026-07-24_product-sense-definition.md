...
topics: [ux-design-process, ux-management]
type: article
---
...
- [The Problems with Existing Product-Sense Definitions and Advice](#toc-the-problems-with-existing-product-sense-definitions-and-advice-1)
- [What Real Product Sense Is Built On](#toc-what-real-product-sense-is-built-on-2)
- [How Do I Develop Strong Product Sense?](#toc-how-do-i-develop-strong-product-sense-3)
- [Conclusion](#toc-conclusion-4)
- [References](#toc-references-5)

## The Problems with Existing Product-Sense Definitions and Advice

The most widely cited definition of product sense comes from [Jules Walter in](https://www.lennysnewsletter.com/p/product-sense)[Lenny's Newsletter](https://www.lennysnewsletter.com/p/product-sense)[from 2022](https://www.lennysnewsletter.com/p/product-sense):
...
![Product Sense is developed through six steps: 1. Understanding problems 2. Recalling patterns 3. Evaluating matches 4. Implementing solutions 5. Measuring outcomes 6. Reflecting and learning](https://media.nngroup.com/media/editor/2026/07/24/updated.png)

Product sense requires you to close the experimentation loop while keeping intuition sharp. 
...
2. Retrieving similar past experiences from memory to identify a plausible solution
3. Evaluating whether that solution would solve the current problem
4. Modifying the solution as needed, or searching for a different option
...
For example, a designer who has successfully improved several [checkout](https://www.nngroup.com/articles/mobile-checkout-ux/) flows may be able to diagnose and fix a similar checkout problem without extensive new research or ideation, assuming the users’ priorities and sensitivities are comparable.
...
1. Assess the initial situation (whether it's a bug fix, user pain point, feature request, or stakeholder mandate)
2. Develop the best solution you can
3. Implement the solution
4. Measure the outcomes of your work
5. Reflect on how successful your efforts were
...
- Document your decision-making logic *before* looking at results. [Be specific about your hypotheses](https://www.nngroup.com/videos/research-goals-questions-hypotheses/). What [quantitative](https://www.nngroup.com/articles/quantitative-research-study-guide/) or [qualitative](https://www.nngroup.com/articles/metrics-qualitative/) outcomes do you expect to see from your choice?
- [Measure real outcomes](https://www.nngroup.com/articles/outcomes-vs-features/), don’t just judge your success based on the outputs you’ve created, and hurriedly move on to what’s next.
- [Reflect:](https://www.nngroup.com/articles/ink-thinking/)
...
[2] Daniel Kahneman and Gary Klein. 2009. Conditions for intuitive expertise: A failure to disagree. *American Psychologist 64*, 6 (2009), 515–526.[https://doi.org/10.1037/a0016755](https://doi.org/10.1037/a0016755)
