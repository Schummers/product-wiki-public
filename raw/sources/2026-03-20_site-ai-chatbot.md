...
- [Many Chatbots Aren’t Discoverable](#toc-many-chatbots-arent-discoverable-1)
- [Past Experiences Make Users Skeptical](#toc-past-experiences-make-users-skeptical-2)
- [Chatbots Don’t Communicate What They Can Do](#toc-chatbots-dont-communicate-what-they-can-do-3)
- [Some Chatbots Offer Help that Users Seek Elsewhere](#toc-some-chatbots-offer-help-that-users-seek-elsewhere-4)
- [AI Can Be Less Efficient than Traditional Search Methods](#toc-ai-can-be-less-efficient-than-traditional-search-methods-5)
- [Where Chatbots Can Help](#toc-where-chatbots-can-help-6)
- [Takeaways for AI Chatbot Designers](#toc-takeaways-for-ai-chatbot-designers-7)

## Many Chatbots Aren’t Discoverable

Many AI chat features have been around for at least a year. One of the big issues a year ago was that [users simply didn't notice them](https://www.nngroup.com/articles/discoverability-ai-amazon/). We expected that, with time, users would come to learn about and expect these features. That still seems not to be the case.
...
![Home Depot's homepage. It has a chat button on the right upper side, and an icon representing AI on the lower right side.](https://media.nngroup.com/media/editor/2026/03/17/home_depot_hidden_chat.jpg)

*Home Depot’s AI Chatbot,* Magic Apron *, (bottom, right) was hard to discover. On the desktop, the bot’s icon was small, lacked an informative text label, and blended in with the background due to the use of branded colors. Additionally, it competed with another chat option on the top-right of the screen.*
...
Making these features more [discoverable](https://www.nngroup.com/videos/findability-vs-discoverability/) doesn’t mean making them disruptive. Participants appreciated that the AI chatbots stayed out of their way — the issue was that they were too easy to ignore.
...
![The Turo homepage. It has a button with "Ask Turo" and sparkles in the top right corner near a hamburger icon.](https://media.nngroup.com/media/editor/2026/03/17/turo-homepage.jpg)

*Turo's AI chat feature,* Ask Turo *, can be found from the top-right corner of the screen.*

![Redfin's homepage. The user has clicked into the search bar labeled "Buy." A popup appears in the results below that says "Search smarter, powered by AI."](https://media.nngroup.com/media/editor/2026/03/17/redfin_ai_search.jpg)

*Redfin's AI chatbot can be activated from the site search.*
...
Even when users are willing to try a chatbot, most do a poor job of communicating what they can actually help with. Many of the chatbots we tested didn't clearly explain their capabilities, leaving participants unsure and confused. **This is a new form of an old problem:**[weak information scent](https://www.nngroup.com/articles/information-scent/). Just like with vague link labels, users won’t click on things for fun. They explore what [promises them value](https://www.nngroup.com/articles/link-promise/).
...
![Turo's AI chabot, Ask Turo, tells users, "I'm here to answer your questions and help you find any info you need on Turo. How can I help?"](https://media.nngroup.com/media/editor/2026/03/16/ask-turo-welcome-message.jpg)

Ask Turo,*the AI chatbot for Turo, had a vague welcome message that didn’t adequately highlight its capabilities.*
...
![Ask Turo is replying to a request to find cars with: "Perfect! Turo has a wide selection of vehicles that can fit three people for your trip from Hampton, GA to Orlando, FL." Then, it replies with many instructions on how to find a car.](https://media.nngroup.com/media/editor/2026/03/17/turo-answer.jpg)

Ask Turo *can’t suggest or help users find suitable cars, which is what some users expected it to do.*
...
![The AI Chatbot for Williams Sonoma's welcome message reads: "Hi there! I'm Olive, your AI Sous Chef! Whether you need help finding the perfect cookware, discovering this season's most-loved kitchen essentials or looking for recipes to inspire your next gathering. I'm here to guide you every step of the way. What can I help you with today?"](https://media.nngroup.com/media/editor/2026/03/16/williams_sonoma_welcome_message.jpg)

*Williams Sonoma’s AI chatbot’s opening message highlights its potential use cases: finding cookware and suggesting recipes.*
...
Even if a chatbot clearly articulates its purpose, **that purpose still must align with what users actually want to accomplish on the site**. (All this boils down to the same old advice: [don’t start with AI, start with the problem](https://www.nngroup.com/videos/dont-start-with-ai/).)

Users have other go-to places for information-seeking tasks (like search engines or general-purpose [genAI chatbots such as ChatGPT or Gemini](https://www.nngroup.com/articles/ai-changing-search-behaviors/)), and they provide much more comprehensive answers.
...
![Home Depot's AI Chatbot, Magic Apron is shown. The welcome message reads "Hi! Need help with a product, project or question? I'm here to assist. What can I help you with today?" Below it are three suggestions that are clickable. The questions read: "What is on sale right now?" "What materials do I need to build a basic garden bed?" "How do I protect pipes and faucets from freezing?"](https://media.nngroup.com/media/editor/2026/03/16/home_depot_welcome_message.jpg)

*Home Depot’s* Magic Apron *AI Chat offered helpful advice for tackling DIY projects, but users didn’t think to use it for this.*
...
**Most people start an**[information-seeking task](https://www.nngroup.com/articles/information-seeking-expectations/) by using ****[a search engine or a general-purpose AI chatbot](https://www.nngroup.com/articles/ai-changing-search-behaviors/)**, rather than a specific retailer’s website.**
...
![A user has asked Home Depot's AI Chatbot how to replace a bathroom sink. The beginning of the chatbot's response is: "Installing a new bathroom sink can be a rewarding DIY project. However, if you prefer professional assistance, The Home Depot offers Sink Installation services for eligible sinks purchased in-store and online."](https://media.nngroup.com/media/editor/2026/03/16/home_depot_response.jpg)

Magic Apron’*s response started with an advertisement for Home Depot’s installation services.*
...
Some chatbots tried to help with the core task — finding products or information. However, several participants questioned why they would use a chatbot for this when the sites already included well-established features such as site [search](https://www.nngroup.com/articles/search-visible-and-simple/), [filters](https://www.nngroup.com/articles/filters-vs-facets/), and [navigation](https://www.nngroup.com/videos/search-box-vs-navigation/).
...
![A user has asked Magic Apron for paint. Two paint products are visible in a carousel. To see more, users must click to scroll horizontally.](https://media.nngroup.com/media/editor/2026/03/17/home_depot_carousel.jpg)

*HomeDepot’s AI Chat showcased products — which users liked — but viewing all the options in a carousel was effortful and required multiple clicks.*
...
![A user has asked Redfin's Virtual Assistant to show them homes in the historic district of Bloomington, indiana between 450-700 USD. Redfin's AI Assistant only shows one result with the keyword "historic district" and asks the user if they want to expand their search.](https://media.nngroup.com/media/editor/2026/03/16/redfin_ai_search.jpg)

*Redfin’s* AI Search *chatbot took up the entire screen, a waste of real estate — pun intended. Users could see only a few houses at a time. To see more, they had to type a search query, which made the process of discovering homes inefficient.*

![A user has searched for homes in Bloomington and is presented with many options and a map of where they can be found.](https://media.nngroup.com/media/editor/2026/03/16/redfin_search_results.jpg)

*Redfin’s traditional search experience presents multiple homes alongside a map. Users can filter the results.*

Search-results pages let users scan and compare at a glance without forgetting what they’ve already seen. When common filters are visible, users can rely on [recognition rather than recall](https://www.nngroup.com/articles/recognition-and-recall/).

Chatbots, on the other hand, offer a much more limited set of results and force users to hold more information in [working memory](https://www.nngroup.com/articles/working-memory-external-memory/) or scroll back to find earlier results. Also, unless a chatbot prompts for all the relevant filters, users have to remember to apply them, and that process is more effortful — usually requiring typing rather than clicking.
...
However, **many AI chatbots seem to be built with the assumption that users will take the first option that seems reasonable enough** (a behavior called “[satisficing](https://www.nngroup.com/articles/satisficing/)”). The chatbots frequently surface only a handful of recommended options based on the details users have provided and use language implying that they expect the user to select one and move forward (e.g., *Would you like me to share more details about this option?*).
...
For example, Turo's chatbot couldn't recommend cars — but it could have answered questions about leasing policies and protection plans, making coverage decisions easier. That's a [better-scoped](https://www.nngroup.com/articles/scope-ai-features/), valuable role.
