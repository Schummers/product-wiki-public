...
date: "2024-02-23"
url: "https://www.nngroup.com/articles/should-you-run-a-survey/"
author: "Maddie Brown"
topics: [research-methods]
type: article
---

Surveys are one of the most frequently utilized research methods by UX designers and researchers. According to a [2019 Nielsen Norman Group study](https://www.nngroup.com/reports/user-experience-careers/), 99% of UX researchers who responded said they run surveys “at least sometimes,” indicating that the practice is nearly ubiquitous. Unfortunately, **this frequently used method is often applied incorrectly,** resulting in unreliable and useless data.

## In This Article:

- [Criticism of Surveys as a Method](#toc-criticism-of-surveys-as-a-method-1)
- [Benefits of Surveys in UX](#toc-benefits-of-surveys-in-ux-2)
- [Survey Myths, Busted](#toc-survey-myths-busted-3)
- [Good Reasons to Run a Survey](#toc-good-reasons-to-run-a-survey-4)
...
In her book, [Just Enough Research](https://abookapart.com/products/just-enough-research), design consultant Erika Hall wrote that,
...
UX thought leader [Tomer Sharon once tweeted](https://twitter.com/tsharon/status/1415025685748502529),
...
- **Play well with other methods****:** Surveys pair well with [qualitative research methods](https://www.nngroup.com/videos/5-qualitative-research-methods/), allowing researchers to supplement their qualitative insights with quantitative heft — often a missing component in convincing skeptical stakeholders.

## Survey Myths, Busted

Even with all these potential benefits, surveys often fail to deliver on their promises.

In many cases, a survey is doomed from the very start because it is the wrong method to employ for the given research goal. [Deciding which method to use](https://www.nngroup.com/articles/which-ux-research-methods/) in order to answer a given research question is always an important (and often overlooked) part of the research planning process.
...
“We want you to conduct 10-12 user interviews and 5-7 usability tests for us, so that we can make X design decision. But here’s the thing: I understand qualitative research. I’ve read [Jakob Nielsen’s famous article](https://www.nngroup.com/articles/why-you-only-need-to-test-with-5-users/) about testing with 5 users. *I* get it. But my CEO doesn’t trust small numbers. They want [statistical significance](https://www.nngroup.com/articles/understanding-statistical-significance/) to feel confident in making a decision. So, to satisfy them, could you also run a survey with 100 people?”
...
Consider the below visualization of [user research methods](https://www.nngroup.com/articles/which-ux-research-methods/).

![A visual matrix of 20 different UX research methods.](https://media.nngroup.com/media/editor/2024/02/15/landscape-2022-07-06.png)
