...
author: "Huei-Hsin Wang, Sarah Gibbons"
topics: [ux-design-process]
type: article
---

There's a lot of discourse around the design process right now: throw out the process, trust your intuition, skip the research, and start building. Jenny Wen, design lead at Anthropic, has been one of its more prominent voices. [The argument](https://www.youtube.com/watch?v=4u94juYwLLM) sounds compelling, especially to designers under pressure to move fast.

## In This Article:

- [The Argument Against Process](#toc-the-argument-against-process-1)
- [Where the Argument Falls Apart](#toc-where-the-argument-falls-apart-2)
- [Process Compression, Not Abandonment](#toc-process-compression-not-abandonment-3)
- [Intuition Does Not Replace Process](#toc-intuition-does-not-replace-process-4)
- [Solution-First Design Works Only in Narrow Contexts](#toc-solution-first-design-works-only-in-narrow-contexts-5)
- [Process Literacy: Match Your Process to the Problem](#toc-process-literacy-match-your-process-to-the-problem-6)
...
- Great work often starts with solutions, not [problem statements](https://www.nngroup.com/articles/problem-statements/). Only after seeing a compelling prototype does one understand the problem it's actually solving.
...
**The double diamond (and**[design thinking](https://www.nngroup.com/articles/design-thinking/)**process) was never meant to be a literal checklist or template to be rigidly followed.** Its purpose is to manage risk: help teams understand problems, explore solutions, and reduce the chance of building the wrong thing.
...
![Block quote saying "What gets called intuition is really process, compressed and internalized.](https://media.nngroup.com/media/editor/2026/03/12/nng_intuition1_sarahgibbonshuei-hsinwang.png)

AI tools accelerate this compression further — and democratize it. [Vibecoding](https://www.nngroup.com/articles/ai-prototyping/) has shrunk the gap between an idea and something testable; exploring, making, learning, and refining can happen in a single afternoon. Where experienced designers have always run the design loop faster than formal frameworks suggest, AI now enables less experienced practitioners to do the same.
...
But the examples Wen uses to argue for solution-first design — such as the successful, widely adopted features of an AI product created by a well-resourced company — reflect survivorship bias. What we don’t see are the [many solution-first experiments that failed](https://www.nngroup.com/articles/ai-user-value/): impressive prototypes that excited internal teams but never resonated with users, or features that shipped but saw little adoption because they didn’t address a meaningful need. Every approach looks brilliant when you showcase only the wins.
...
![A block quote calling for process literacy.](https://media.nngroup.com/media/editor/2026/03/12/nng_processliteracy2.png)
