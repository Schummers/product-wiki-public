...
topics: [ux-design-process, ux-teams]
type: article
---

UX professionals' job is to advocate on behalf of the user. However, in order to do it, not only must we deeply **understand our users**, but we must also **help our colleagues understand** them and prioritize their needs. [Empathy maps](https://medium.com/the-xplane-collection/updated-empathy-map-canvas-46df22df3c8a), widely used throughout agile and design communities, are a powerful, fundamental tool for accomplishing both.

## In This Article:

- [Definition: Empathy Maps](#toc-definition-empathy-maps-1)
- [Format of an Empathy Map](#toc-format-of-an-empathy-map-2)
- [One User vs. Multiple-Users Empathy Maps](#toc-one-user-vs-multiple-users-empathy-maps-3)
- [Why Use Empathy Maps](#toc-why-use-empathy-maps-4)
- [Process: How to Build an Empathy Map](#toc-process-how-to-build-an-empathy-map-5)

## Definition: Empathy Maps
...
![Empathy Map 4 Quadrants](https://media.nngroup.com/media/editor/2017/12/14/screen-shot-2017-12-14-at-55525-pm.png)
...
![Empathy Map Example Buying a TV](https://media.nngroup.com/media/editor/2017/12/14/screen-shot-2017-12-14-at-55628-pm.png)
...
![Empathy Map 5 Quadrants](https://media.nngroup.com/media/editor/2017/12/14/screen-shot-2017-12-14-at-55719-pm.png)

### Conclusion

As their name suggests, empathy maps simply help us build empathy with our end users. When based on real data and when combined with other [mapping methods](https://www.nngroup.com/articles/ux-mapping-cheat-sheet/), they can:
