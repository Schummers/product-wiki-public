---
title: "Anchors OK? Re-Assessing In-Page Links"
date: "2017-05-07"
url: "https://www.nngroup.com/articles/in-page-links/"
author: "Amy Schade"
topics: [content-strategy, mobile-and-tablet-design, web-usability]
type: article
---
...
- [Why In-Page Links Are Confusing](#toc-why-in-page-links-are-confusing-1)
- [Why In-Page Links Are Helpful](#toc-why-in-page-links-are-helpful-2)
- [Common Uses of In-Page Links](#toc-common-uses-of-in-page-links-3)
- [The Impact of Screen Size](#toc-the-impact-of-screen-size-4)
- [How to Use In-Page Links Responsibly](#toc-how-to-use-in-page-links-responsibly-5)
- [So, Good or Bad?](#toc-so-good-or-bad-6)
...
- Provide [direct access](https://www.nngroup.com/articles/direct-vs-sequential-access/) to content of interest
...
- **Indexes and FAQs**: Alphabetical or numeric indexes or lists of [frequently asked questions](https://www.nngroup.com/articles/faqs-deliver-value/) can benefit from in-page links. A list of links at the top of the page saves users the effort of scrolling through numerous items, or screens of items, that are of no use to them. The links are helpful when users are likely to need a specific piece of content, rather than benefit from browsing through all the options.
...
As we are designing for more [diverse devices](https://www.nngroup.com/articles/scaling-user-interfaces/), each with its own screen size, the **benefit of using jump links increases as screen size decreases**. Consider a page of content on your site: a few paragraphs of text may fill one screen-full on desktop, but extend across several scrolling pages on mobile. The same content, even when brief, expands greatly in length simply by appearing on a small screen.

*Viewing a MayoClinic.org artice on a 13" laptop shows 4 paragraphs of text and a video within a single page. The same article viewed on a phone displays only 2 paragraphs.*
...
*Switch.which.co.uk:  If content sections are brief, with more than one section visible on each page, in-page links are unnecessary.*

### Use Clear Links and Headings

Long content benefits from being structured in multiple sections with clear titles, which act as **signposts for the content discussed** in each area of the page. Think of headings as the skeleton (or [mini-IA](https://www.nngroup.com/articles/mini-ia-structuring-information/)) of the page: A user can get an overview of content by scrolling through headings, if those headings are clear and descriptive of the text they label.

But, users may or may not scroll, particularly if a page has many sections of content. Users [scroll when they have a reason](https://www.nngroup.com/articles/page-fold-manifesto/): they assess if the page is likely to contain the content they need and scroll if they believe it might be there. Headings are only helpful if the user sees them.
...
*The links at the top of this USA.gov page clearly identify the content the page contains.*
...
*The in-page links at the top of this EPA.gov page are labeled* On This Page *to clarify how the links will function.*
...
*In an article on WebMD, an in-page link to* What Causes Infection with Noroviruses *leads to the view in the top screenshot, where the heading and initial text are obscured by the sticky navigation. The second screenshot shows the page scrolled to see the appropriate content.*
...
This type of indicator serves to orient users on the page and does, on a page-level scale, what [you-are-here navigation](https://www.nngroup.com/articles/navigation-you-are-here/) does for the site as a whole.
...
Accordions can also be used to implement tables of content, FAQs or indexes. They provide an overview of the page and give users direct control over which content to view both on [desktop](https://www.nngroup.com/articles/accordions-complex-content/)and [mobile](https://www.nngroup.com/articles/mobile-accordions/). This design pattern allows users to expand or collapse sections of content. When content sections are closed, they act as a table of contents for the page.
