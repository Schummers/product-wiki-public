---
title: "Website Forms Usability:  Top 10 Recommendations"
date: "2016-05-01"
...
Intentional or not, this arrangement undoubtedly reduces the volume of complaints! However it also violates a form-design guideline we first wrote about more than 15 years ago: to [avoid Reset buttons](https://www.nngroup.com/articles/reset-and-cancel-buttons/) on web forms.
...
1. **Avoid placeholder text**. Designers like placeholder text because it eliminates visual clutter. But [placeholder text causes many usability problems](https://www.nngroup.com/articles/form-design-placeholders/), and is best avoided.
...
The usability of web forms is by no means a new topic. It has been covered in general usability references (including several NN/g books of both [general usability](https://www.nngroup.com/books/prioritizing-web-usability/) guidelines, [eyetracking usability](https://www.nngroup.com/books/eyetracking-web-usability/) research, and [mobile usability](https://www.nngroup.com/books/mobile-usability/)). Many of the [114 UX guidelines for e-commerce shopping carts](https://www.nngroup.com/reports/ecommerce-ux-shopping-carts-checkout-registration/) are specialized issues in forms design. There are also entire books specifically written about [form design](http://www.amazon.com/dp/1558607102?tag=useitcomusablein), as well as academic studies demonstrating the effectiveness of complying with guidelines.
