...
![UPS chatbot page](https://media.nngroup.com/media/editor/2018/11/15/ups.PNG)
...
![A decision tree for ordering food; depending on the type of food different branches are chosen; then there are nodes for subsequent option for that food (e.g., crust for pizza)](https://media.nngroup.com/media/editor/2018/11/15/model.png)
