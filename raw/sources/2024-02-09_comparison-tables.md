...
- [When You Need a Comparison Table](#toc-when-you-need-a-comparison-table-2)
- [When You Don’t Need a Comparison Table](#toc-when-you-dont-need-a-comparison-table-3)
- [Types of Comparison Tables](#toc-types-of-comparison-tables-4)
- [Static Comparison Tables](#toc-static-comparison-tables-5)
- [Dynamic Comparison Tables](#toc-dynamic-comparison-tables-6)
- [Best Practices for Comparison Tables](#toc-best-practices-for-comparison-tables-7)
- [The Golden Rule of Comparison Tables](#toc-the-golden-rule-of-comparison-tables-8)
...
When people have to choose among many alternatives, it’s hard to compare the pros and cons of each individual alternative. As a result, people engage in [noncompensatory decision](https://www.nngroup.com/articles/compensatory-noncompensatory-decisions/)**making** — in other words, using one factor as the basis for decision-making.
...
![Amazon screenshot of five floral dresses. Below, the dresses are compared by cut, length, sleeve, and design.](https://media.nngroup.com/media/editor/2024/02/02/screenshot-2023-08-22-at-115042-am.png)

❌ *amazon.com: A comparison table of similar dresses isn’t necessary.*

![Amazon screenshot of two similar dresses. They are labeled "buy with" and have the option to add both dresses to the user's cart.](https://media.nngroup.com/media/editor/2024/02/02/screenshot-2023-08-22-at-115007-am.png)
...
When a product or service is cheap or easily replaceable, users are likely to engage in [satisficing](https://www.nngroup.com/articles/satisficing/) behavior and not spend much time analyzing alternatives. People don’t need to compare various rolls of paper towels, for example.

![In this screenshot, jetpens.com has a long comparison table comparing three black pens on a variety of different qualities.](https://media.nngroup.com/media/editor/2024/02/02/compare-products-_-jetpens.png)
...
![This is a screenshot of a comparison table comparing the three most recent Apple Watches.](https://media.nngroup.com/media/editor/2024/02/02/apple-watch-compare-models-apple-1.png)
...
![A screenshot of the Apple navigation menu. It has options for all the Apple Watches and one comparison option, which NN/g has highlighted in blue.](https://media.nngroup.com/media/editor/2024/02/02/unnamed.png)
...
![A screenshot of the Home Depot website compared to the Lowes website. Both sites have options to compare selections but one is a button and the other is a checkmark.](https://media.nngroup.com/media/editor/2024/02/02/paintcompare.png)
...
![A screenshot of Garmin.com showing the compare button at the top of product listings.](https://media.nngroup.com/media/editor/2024/02/02/garmin-marine-radars.png)
...
![A screenshot of the Apple website comparing Mac computers. The comparison table takes up a small portion of the middle of the screen but the rest is white space.](https://media.nngroup.com/media/editor/2024/02/02/applebigscreenshot.png)
...
![A screenshot of two cameras in a comparison table. One is missing metadata.](https://media.nngroup.com/media/editor/2024/02/02/compare-best-buy.png)
...
![A screenshot of a comparison table on Smugmug.com. This comparison table is playful with all of the plans having the exact same features.](https://media.nngroup.com/media/editor/2024/02/02/smugmugzip.png)
...
![A long comparison table showing the different features of the All-Clad pan line.](https://media.nngroup.com/media/editor/2024/02/02/all-clad-cookware-buying-guide-_-williams-sonoma.png)
...
![A comparison table of three FitBits. Each FitBit has a different color representing its features in the table. From left to right: navy blue, light blue, and black.](https://media.nngroup.com/media/editor/2024/02/02/smartwatches-_-shop-fitbit.png)
...
![This is a comparison table for TechSmith's various software offerings. Each column is a different color to show the distinct offerings.](https://media.nngroup.com/media/editor/2024/02/02/techsmith.png)
...
![This is a screenshot of the Adobe comparison table. The screenshot shows the table scrolled slightly lower on the page, obscuring the column headers.](https://media.nngroup.com/media/editor/2024/02/02/adobe.png)
...
![A screenshot of a comparison table of Amazon portable chargers. Under size, each product has its dimensions in inches but also in the size of a similar household product. For example the three chargers from left to right are labeled: lipstick, candybar, and candybar.](https://media.nngroup.com/media/editor/2024/02/02/amazonsize.png)
...
![When hovered over, Dropbox will show a tool tip explaining the features of their signing tool.](https://media.nngroup.com/media/editor/2024/02/02/dropboxtooltip.png)
...
![Screenshot showing how Bestbuy will highlight differences in their comparison table](https://media.nngroup.com/media/editor/2024/02/02/compare-best-buy-washer.png)
...
![This is a screenshot of SmugMug's at-a-glance comparison table. To make it easy to understand, the table only has a few comparison points and the main differences, like price, at the top.](https://media.nngroup.com/media/editor/2024/02/02/smugmug-prices-plans.png)

✅ *smugmug.com: For its 3 plan options, SmugMug presented a very simplified “at a glance” comparison table.*

![This is the more detailed version of the SmugMug comparison table. Unlike the at-a-glance, this table compares all factors of the plan.](https://media.nngroup.com/media/editor/2024/02/02/smugmug-prices-plans-copy.png)
...
![This is a screenshot of Shopify's mobile comparison table. Instead of showing all the plans on one screen. The user can click tabs at the top to select the plan they want to look at.](https://media.nngroup.com/media/editor/2024/02/02/shopifymobile.jpeg)
