...
author: "Maria Rosala"
topics: [research-methods, ux-design-process]
type: article
---
...
- [When Is a Discovery Needed?](#toc-when-is-a-discovery-needed-2)
- [Common Activities in Discovery](#toc-common-activities-in-discovery-3)
- [People Involved](#toc-people-involved-4)
- [The Outcome of a Discovery](#toc-the-outcome-of-a-discovery-5)
...
*Discovery should tackle unknowns across users, the business, and the technological landscape, in order to identify desirable, feasible, and viable solutions*
...
**A discovery is needed anytime there are many unknowns** that stop a team from moving forward.[Moving forward on only assumptions](https://www.nngroup.com/articles/tracking-questions-assumptions-facts-agile/) can be risky, as the team may end up solving a problem that doesn’t really matter — wasting time, money, and effort.
...
## Common Activities in Discovery
...
Common exploratory research methods include[user interviews](https://www.nngroup.com/articles/user-interviews/),[diary studies](https://www.nngroup.com/articles/diary-studies/), and[field studies](https://www.nngroup.com/articles/field-studies/) with a representative group of users. [Surveys](https://www.nngroup.com/articles/surveys-design-cycle/) can also be used to gather data from a larger group of users; the data can be triangulated with qualitative insights from other methods.
...
- High-level concepts or[wireframes](https://www.nngroup.com/videos/prototypes-vs-wireframes-ux-projects/) (for exploring in the next phase)
...
UK Design Council’s Double Diamond Model:[What is the framework for innovation? Design Council's evolved Double Diamond](https://www.designcouncil.org.uk/news-opinion/what-framework-innovation-design-councils-evolved-double-diamond).
