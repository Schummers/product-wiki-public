---
title: "Incentive Structures for Diary Studies"
date: "2026-06-19"
url: "https://www.nngroup.com/articles/diary-study-incentives/"
author: "Maria Rosala"
topics: [research-methods]
type: article
---

Compared to other UX research studies, [diary studies](https://www.nngroup.com/articles/diary-studies/) — especially longer ones — are particularly vulnerable to **high participant attrition** — when participants stop submitting entries or responding. One of the strongest levers against attrition is the incentive structure itself.
...
- [How Incentives Are Different for Diary Studies](#toc-how-incentives-are-different-for-diary-studies-1)
- [Common Incentive Structures for Diary Studies](#toc-common-incentive-structures-for-diary-studies-2)
- [Payment Timing](#toc-payment-timing-3)
- [Communicating Incentive Structures](#toc-communicating-incentive-structures-4)

## How Incentives Are Different for Diary Studies

Unlike [moderated sessions](https://www.nngroup.com/articles/remote-usability-tests/), where participants are typically compensated for their *time*, diary studies usually compensate participants for their *effort*. Participants shouldn’t be compensated if they provide too few or no entries, so incentives are often tied to the quantity — and sometimes the quality — of submissions.
...
Incentive Structure | Best for... | Pay for a minimum number of entries | ✅ Short and simple studies | Pay per entry | ✅ Longer studies with more involved entries | Tiered pay-per-entry structure | ✅ Certain behaviors matter more than others

**These incentive structures can be blended.** For example, a study might have a minimum number of entries to receive payment. However, participants who want to provide more than the study minimum can be compensated further with a pay-per-entry incentive structure.

Additionally, you can offer bonus payments to motivate participants to report consistently or provide helpful entries.
...
This incentive structure is best where providing entries is effortful. For example, if participants are required to record a video, answer many questions, or provide photographs, paying per entry can make the effort feel worthwhile.

**How much you pay per entry depends on the effort required** to submit it and who is participating in the study. In some of our diary studies with members of the general public in the US, we’ve paid them from as little as a few dollars to as much as $15 per submission.
...
![A graphic titled "Tiered Payment Schedule for a 4-Week Diary Study," showing four identical weeks. Each week has 8 diary entries: the first 4 (yellow) pay $15 each and the last 4 (purple) pay $5 each.](https://media.nngroup.com/media/editor/2026/06/05/tiered-payment-horizontal.png)

*To encourage reporting throughout the reporting period, participants were offered a higher amount for the first few submissions each week over a 4-week study period*

![A graphic titled "Tiered Payment Schedule for a 4-Week Diary Study," showing four identical weeks. Each week has 8 diary entries: the first 4 (yellow) pay $15 each and the last 4 (purple) pay $5 each.](https://media.nngroup.com/media/editor/2026/06/05/tiered-payment-vertical.png)
...
You can use bonus payments alongside any of the three incentive structures we’ve discussed.

When used appropriately, bonus payments can encourage the consistency, completeness, or responsiveness of reporting.
...
Finally, for an incentive structure to be effective, it needs to be understood by participants. While reducing complexity can help, communication is key.

Ensure that when participants are recruited and onboarded, they are provided with all the details of the incentive structure. Don’t expect participants to remember information you verbally convey!
...
Diary-study incentives shape participant behavior, influencing how often participants respond, how consistently they participate, and the kinds of entries they submit.

There is no single “best” incentive structure. The most appropriate incentive structure is one that meets your study priorities and yields the types of data you need. When aligned with study goals, incentive structures can improve both participation consistency and data quality.
