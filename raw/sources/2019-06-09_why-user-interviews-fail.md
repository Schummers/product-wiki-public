...
date: "2019-06-09"
url: "https://www.nngroup.com/articles/why-user-interviews-fail/"
author: "Maria Rosala"
topics: [research-methods]
type: article
---

User interviews are an important generative method for UX. Generative methods (like interviews and focus groups) produce knowledge. In contrast, evaluative methods (like a [usability test](https://www.nngroup.com/articles/users-real-data/) of a draft design)**test hypotheses. When interviews are done well, we learn about our users’:
...
- [Issue #1: Wrong Purpose](#toc-issue-1-wrong-purpose-1)
- [Issue #2: No Stakeholder Buy-in for Interviews and Their Findings](#toc-issue-2-no-stakeholder-buy-in-for-interviews-and-their-findings-2)
- [Issue #3: Poor Planning](#toc-issue-3-poor-planning-3)
- [Issue #4: Poor Analysis](#toc-issue-4-poor-analysis-4)
- [Improve Your Interview Skills](#toc-improve-your-interview-skills-5)
...
1. *The participant prefers a color*. Asking participants which color they prefer suggests that they should think about and have an opinion about color. They may not, but simply being asked may make them form an opinion. (This is known as the [query effect](https://www.nngroup.com/articles/interviewing-users/).)
