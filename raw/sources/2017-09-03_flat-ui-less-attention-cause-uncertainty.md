...
author: "Kate Moran"
topics: [eyetracking, visual-design]
type: article
---
...
- [Weak Signifiers Increase Interaction Cost](#toc-weak-signifiers-increase-interaction-cost-3)
- [When Flat Designs Can Work](#toc-when-flat-designs-can-work-4)
- [Limitations of the Study](#toc-limitations-of-the-study-5)
...
![Side-by-side comparison of two versions of a hotel web page](https://media.nngroup.com/media/editor/2017/08/28/cos-cow-blank-1.png)
...
![Strong signifier version of Priceline search results, with heat focused over left sidebar. Weak version, with heat distributed across other elements on the page](https://media.nngroup.com/media/editor/2017/10/27/prs-prw-heat-w.png)
...
![Closeup of the two treatments of the Hertz target link](https://media.nngroup.com/media/editor/2017/08/28/hzs-hzw-blank.png)

*Hertz homepage: Closeup of the target tabs (* View/Modify/Cancel a Reservation *) for the strong (left) and weak (right) versions*

![Heatmap of the strong version of Hertz](https://media.nngroup.com/media/editor/2017/10/27/hzs-25ppts-radius142-max17-w-2.png)
...
![Heatmap of weak version of Hertz](https://media.nngroup.com/media/editor/2017/10/27/hzw-29ppts-radius142-max-20-w-2.png)
...
![Brilliant Earth, strong version](https://media.nngroup.com/media/editor/2017/08/28/bes-blank.png)
...
![Closeup of different text treatments](https://media.nngroup.com/media/editor/2017/08/28/bes-bew-blank.png)

*Brilliant Earth: Closeup of the target link (* Shop Pearl *) for the strong (left) and weak (right) versions*

![Side-by-side comparison of the heatmaps for both versions of the Brilliant Earth page](https://media.nngroup.com/media/editor/2017/10/27/bes-bew-heat-w.png)
...
![Side-by-side comparison of both Ally Bank page versions](https://media.nngroup.com/media/editor/2017/08/28/abs-abw-blank.png)
...
**Note:** This article's publication generated a significant amount of debate about flat design. I've written [responses to some of the questions and concerns](https://www.nngroup.com/articles/response-criticisms-flat-design/) I heard about the study.
