...
topics: [branding, strategy, ux-design-process]
type: article
---
...
- [Why Use a Design System?](#toc-why-use-a-design-system-1)
- [Why Not Use a Design System?](#toc-why-not-use-a-design-system-2)
- [Elements of a Design System](#toc-elements-of-a-design-system-3)
- [How to Approach Design-System Adoption](#toc-how-to-approach-design-system-adoption-4)
...
![NASA's Style Guide from 1976, featuring guidance for signage typography to ensure high visibility.](https://media.nngroup.com/media/editor/2021/03/24/nasa-styleguide.jpg)
...
![MailChimp's Content Style Guide, which features guidance for legal copy](https://media.nngroup.com/media/editor/2021/03/25/mailchimp-content-style-guide-compressed.png)
...
![Google's Material Design component library, which features an example of a radio button with guidelines and code.](https://media.nngroup.com/media/editor/2021/03/25/materialdesign-radiobutton-compressed.jpg)

*Google’s*[Material Design system](https://www.material.io/)*features a component library which includes implementation guidelines and code snippets (shown above) for specific operating systems and frameworks, as well as thorough design guidelines with usability do’s and don’ts in a separate tab.*

![IBM's Carbon Design System, which features guidelines, visual examples, as well as a "sandbox" for code testing.](https://media.nngroup.com/media/editor/2021/03/25/carbon-datepicker-compressed.jpg)

[IBM’s Carbon design system](https://www.carbondesignsystem.com/)*features usage, style, and code guidelines, as well as accessibility considerations and a code sandbox for designers and developers to visualize any customizations before implementation.*
...
![Atlassian's Pattern Library, demonstrating the Page Header pattern (and the components which comprise it)](https://media.nngroup.com/media/editor/2021/03/24/atlassian-pageheader-pattern.png)

*The*[Atlassian design system](https://atlassian.design/)*identifies a number of reusable patterns including a page-header template. Not only does it show a visual example, but it also highlights the exact component that designers should leverage and explains how each component should be used.*

![The US Web Design System (USDWS) features an Authentication page template and a visual example with placeholder text](https://media.nngroup.com/media/editor/2021/03/25/uswds-template-compressed.jpg)

*While many public-sector websites have a long way to go, the*[US Web Design System (USWDS)](https://designsystem.digital.gov/)*is a great starting point to unify many disparate departments and agencies with clear guidelines. The USWDS specifies page templates (pictured above), as well as design principles, components, and coding specifications.*
...
![3 Approaches to Implementing a Design System, from low to high control, cost, and brand differentiation: Adopt, Adapt, and Create](https://media.nngroup.com/media/editor/2021/03/24/designsystem-controlspectrum001.png)
