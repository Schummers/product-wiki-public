---
title: "Getting Users to a Specific Feature in a Usability Test"
date: "2016-03-06"
url: "https://www.nngroup.com/articles/feature-user-test/"
...
- [Why You Shouldn’t Take Users to Target Pages](#toc-why-you-shouldnt-take-users-to-target-pages-1)
- [When You May Take Users to Target Pages](#toc-when-you-may-take-users-to-target-pages-2)
- [Shortcut to Target Pages](#toc-shortcut-to-target-pages-3)
...
- **In real life, there’s no silver bell that rings when users finally arrive at the right page.** Users treat *every* page with a healthy dose of skepticism: job #1 upon arrival at any page is for the user to [judge whether it’s even worth the time to stay](https://www.nngroup.com/articles/how-long-do-users-stay-on-web-pages/) on the page and engage with it more deeply. If the study facilitator designates a particular page as the right one, you will never observe the common scenario of users arriving at the right page only to reject it because it doesn’t immediately communicate its purpose.
...
Furthermore, we had many other things to test and limited research time available in Singapore. So we decided to take a shortcut and bring the study participants directly to the PayLah! page, at [http://www.dbs.com.sg/personal/deposits/pay-with-ease/dbs-paylah](http://www.dbs.com.sg/personal/deposits/pay-with-ease/dbs-paylah) (shown above).
