...
date: "2025-05-09"
url: "https://www.nngroup.com/articles/ux-job-with-ai/"
author: "Raluca Budiu"
topics: [ai, careers-ux]
type: article
---
...
- [UX Tools Are Constantly Changing](#toc-ux-tools-are-constantly-changing-1)
- [AI Is a Tool](#toc-ai-is-a-tool-2)
- [New Methods Will Emerge](#toc-new-methods-will-emerge-3)
- [The UX Skills We Will Need](#toc-the-ux-skills-we-will-need-4)
...
I used that watch exactly once. Soon, **the earliest unmoderated usability-testing platforms**(like UserZoom and UserTesting.com) arrived. We started using them for [quantitative user testing](https://www.nngroup.com/articles/quant-vs-qual/) (and for qualitative testing also). My stopwatch was no longer needed — these systems would automatically record the time, way more accurately than I could with that watch.
...
Research Tools: Then and Now | 20 Years Ago | Today | A special testing computer for the participant to use during the session | Zoom or other video-conferencing tool | Screen-recording software (e.g.,  Morae) | Webcam for recording the participant’s face | A computer or a notepad to take notes | AI transcription | A stopwatch to record time | Quantitative-study platforms like UserZoom | Cash to pay the participant at the end | Tremendous or other services for rewarding  participants
...
Take usability testing, for example. We don’t do usability testing because we love chatting with users or watching them stumble. We do it because it helps us identify usability issues in an interface. [Testing with five users allows us to find 85% of the usability issues](https://www.nngroup.com/articles/why-you-only-need-to-test-with-5-users/) in a UI, fix them, and move to the next design iteration.
...
When a new technology appears, it often prompts the creation of new research methods. For example, [customer-journey maps](https://www.nngroup.com/articles/customer-journey-mapping/) became popular once mobile devices became ubiquitous. People began freely transitioning across devices to accomplish a single goal, so we had to think beyond individual channels and consider that broader goal.

Similarly, **we will need new methods for studying and designing AI-based interactions.** If [generative UIs](https://www.nngroup.com/articles/generative-ui/) are dynamically built to suit a user’s specific needs, we will need ways to evaluate them. How will we judge if the AI-generated interface is good or bad? What inputs must we give the AI to produce a usable experience? What data should the AI use to generate that interface?
