...
topics: [branding, persuasive-design, visual-design]
type: article
---

While in Singapore for our [UX Conference](https://www.nngroup.com/ux-conference/), we conducted a usability study to investigate major differences between how Western and Asian cultures evaluate websites — and, by extension, businesses. While there were some interesting [cultural nuances](https://www.nngroup.com/articles/cultural-nuances/), the **basic factors used to weigh site trustworthiness were the same**, regardless of location and culture.

In 1999 Jakob Nielsen listed **4 ways in which a website can**[communicate trustworthiness](https://www.nngroup.com/articles/communicating-trustworthiness/): design quality, up-front disclosure, comprehensive and current content, and connection to the rest of the web. In our study, we observed that *these very same factors* continue to influence users. This is yet another example of the [durability of usability guidelines](https://www.nngroup.com/articles/durability-of-usability-guidelines/): although design patterns and trends change over time, human behavior does not. Users’ priorities and methods of evaluation are the same today as they were 17 years ago, even though the web itself has vastly evolved. What we now consider a “quality” website design looks very different from a reputable website of the past, but what influences the perception of quality has not changed and will not change in the future.
...
- [Design Quality](#toc-design-quality-1)
- [Upfront Disclosure](#toc-upfront-disclosure-2)
- [Comprehensive, Correct, and Current](#toc-comprehensive-correct-and-current-3)
- [Connected to the Rest of the Web](#toc-connected-to-the-rest-of-the-web-4)
...
**Site organization**. Meaningful navigation labels indicate that the company considers users’ needs and understands their [mental models](https://www.nngroup.com/articles/mental-models/) and vocabulary. When people are faced with [clever or nondescript category names](https://www.nngroup.com/articles/category-names-suck/), they may not be able to determine whether the relevant content exists on the site. As a result, they will become frustrated and may abandon the site. In contrast, when the links unambiguously point users in the right direction, they will feel confident and will trust your company.

**Visual design**. The [standard](https://www.nngroup.com/articles/the-need-for-web-design-standards/) for what is considered a well-designed site constantly shifts in response to trends that eventually become the norm. For example, perhaps [young adults consider flat designs as more professional](https://www.nngroup.com/articles/young-adults-flat-design/) than older audiences simply because they use more websites that have adopted a [minimalist style](https://www.nngroup.com/articles/characteristics-minimalism/), and have adjusted their expectations over time.
...
![Screenshot of 2 snack-delivery websites with different imagery designs.](https://media.nngroup.com/media/editor/2016/05/02/snackcompetitors_highres)
...
![Screenshot of Portfolio page on HomeCleanz website.](https://media.nngroup.com/media/editor/2016/05/02/homecleanz_portfolio_highres.png)
...
(Even if you don’t have an [omnichannel user-experience strategy](https://www.nngroup.com/courses/cross-channel-user-experience/), your customers employ an [omnichannel approach to their information seeking](https://www.nngroup.com/articles/users-interleave-sites-and-genres/).)
...
Learn more about credibility and establishing trust in our [full-day training course on Persuasive Web Design](https://www.nngroup.com/courses/credibility-and-persuasive-web-design/).
