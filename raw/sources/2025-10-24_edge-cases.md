---
title: "The Edge Cases that Break Hearts (And Products)"
date: "2025-10-24"
url: "https://www.nngroup.com/articles/edge-cases/"
author: "Laura Klein"
...
- [Edge Cases Are Tough](#toc-edge-cases-are-tough-1)
- [The Cases We Don't Think About](#toc-the-cases-we-dont-think-about-2)
- [The Cases We Don't Want to Think About](#toc-the-cases-we-dont-want-to-think-about-3)
- [The Technical Realities We Avoid](#toc-the-technical-realities-we-avoid-4)
- [Accessibility as an Afterthought](#toc-accessibility-as-an-afterthought-5)
- [Stop Designing for Perfect People](#toc-stop-designing-for-perfect-people-6)
...
- Have multiple account-recovery options that don't all depend on the same device.
- Make your support-contact information findable and usable when someone isn't logged in.
...
- Build safety features from the ground up, not only as a response to problems.

- Make blocking and reporting easy and effective.

- Introduce some friction in account creation to make it difficult for people to automate abusive behaviors through infinite sock-puppet accounts.
...
- Do not send collaboration invites to inactive accounts after a reasonable period.

- Let people opt out of potentially sensitive email notifications around holidays or promotions.
...
- Design for both asynchronous and real-time collaboration.

- Show clear conflict resolution.
- Make it obvious when someone's changes aren't saving.

- When there is a merge conflict between various edits, ask for guidance from the users.

- Enable change tracking and the ability to accept or reject changes.
...
Obviously, there are a lot of [great resources](https://www.nngroup.com/articles/accessibility-inclusivity-study-guide/) on how to design better for all of the different accessibility requirements. We can’t provide an exhaustive list of dos and don’ts in this article, but be sure to remember that accessibility isn’t a feature to add later. It’s a design constraint to embrace and plan for from day one. Learn how to build accessible products and test them with real assistive technologies and actual users!
